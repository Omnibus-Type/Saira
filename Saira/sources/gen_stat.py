...
UPRIGHT_AXES = [
    dict(
        ...
        ordering=0,
        values=[
            dict(nominalValue=50, rangeMinValue=50, rangeMaxValue=62.5, name="UltraCondensed"),
            dict(nominalValue=62.5, rangeMinValue=62.5, rangeMaxValue=75, name="ExtraCondensed"),
