...
UPRIGHT_AXES = [
    dict(
        ...
        ordering=0,
        values=[
            dict(nominalValue=50, name="UltraCondensed"),
            dict(nominalValue=62.5, name="ExtraCondensed"),
            dict(nominalValue=75, name="Condensed"),
            dict(nominalValue=87.5, name="SemiCondensed"),
            dict(nominalValue=100, name="Normal", flags=0x2),
            dict(nominalValue=112.5, name="SemiExpanded"),
            dict(nominalValue=125, name="Expanded"),
        ],
    ),
    dict(
        tag="wght",
